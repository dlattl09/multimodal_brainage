...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
        ...
        self.bn_f1 = nn.BatchNorm1d(530)
        self.fc_f1 = nn.Linear(530,200)
       # self.dropout = nn.Dropout(p=0.2)
        self.bn_f2 = nn.BatchNorm1d(200)
        self.fc_f2 = nn.Linear(200,100)
        self.bn_f3 = nn.BatchNorm1d(100)
      
        self.fc1 = nn.Linear(612,1)
